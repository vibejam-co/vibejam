...
exports.recomputeLeaderboards = exports.toggleBookmark = exports.toggleUpvote = exports.signal = exports.scrape = exports.upsertDraft = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
admin.initializeApp();
const db = admin.firestore();
// --- 1. Upsert Jam Draft ---
exports.upsertDraft = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
    ...
    try {
        ...
        const updates = {
            ...patch,
            websiteUrl: websiteUrl || patch.websiteUrl,
...
exports.scrape = functions.https.onCall(async (data, context) => {
...
exports.signal = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        if (e.code === "ALREADY_EXISTS")
            return { ok: true }; // Harmless race
        throw new functions.https.HttpsError("internal", e.message);
    }
});
// --- 4. Toggle Upvote ---
exports.toggleUpvote = functions.https.onCall(async (data, context) => {
    if (!context.auth)
...
// --- 5. Toggle Bookmark ---
exports.toggleBookmark = functions.https.onCall(async (data, context) => {
    if (!context.auth)
        throw new functions.https.HttpsError("unauthenticated", "Login required.");
    const { jamId } = data;
    const uid = context.auth.uid;
...
exports.recomputeLeaderboards = functions.pubsub.schedule("every 60 minutes").onRun(async (context) => {
