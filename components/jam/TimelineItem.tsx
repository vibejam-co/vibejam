...
const TimelineItem: React.FC<TimelineItemProps> = ({
    ...
    return (
        <div className={`relative pl-12 pb-16 ${isLast ? 'pb-0' : ''}`}>
            {/* Line */}
            {!isLast && (
                <div className="absolute left-[5.5px] top-4 bottom-0 w-[1.5px] border-l-[1.5px] border-dashed border-gray-100" />
            )}
            ...
            <div className="animate-in fade-in slide-in-from-left-4 duration-700">
                ...
                <h4 className="text-2xl font-black text-gray-900 tracking-tight mb-3">{label}</h4>

                {body && (
                    <p className="text-gray-500 leading-relaxed max-w-2xl mb-6">{body}</p>
                )}
                ...
                {onDiscussionClick && (
                    ...
                    >
                        <div className="w-8 h-8 rounded-full border border-gray-100 flex items-center justify-center group-hover:bg-gray-50 group-hover:border-gray-200 transition-all">
