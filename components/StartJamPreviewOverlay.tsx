...
import JamPageV2 from './jam/JamPageV2';
...
interface StartJamPreviewOverlayProps {
  ...
  isFirstJamPreview?: boolean;
  isLoggedIn?: boolean;
}

const StartJamPreviewOverlay: React.FC<StartJamPreviewOverlayProps> = ({ open, jam, onClose, onOpenJam, isFirstJamPreview = false, isLoggedIn = false }) => {
