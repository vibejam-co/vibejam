...
const StartJamPreviewOverlay: React.FC<StartJamPreviewOverlayProps> = ({ open, jam, onClose }) => {
    ...
    <div className="fixed inset-0 z-[9999] flex flex-col bg-white animate-in fade-in duration-300">
      <nav className="h-20 border-b border-gray-50 flex items-center justify-between px-6 md:px-12 bg-white/80 backdrop-blur-xl shrink-0">
        ...
        <button 
          ...
          className="px-5 py-2.5 rounded-xl bg-gray-900 text-white text-[10px] font-black uppercase tracking-widest hover:bg-gray-800 transition-all flex items-center gap-2"
        >
      ...
      <div className="flex-1 overflow-y-auto bg-gray-50/30">
        <div className="max-w-5xl mx-auto py-12 px-6">
             ...
             <div className="p-8 md:p-16">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
                  {[
                    ...
                    { label: 'Tools', value: jam.vibeTools.length.toString(), color: 'text-gray-900' }
                  ].map(s => (
          ...
          <div className="mt-12 text-center">
             <button onClick={onClose} className="text-[11px] font-black text-gray-300 uppercase tracking-widest hover:text-gray-900 transition-all">
